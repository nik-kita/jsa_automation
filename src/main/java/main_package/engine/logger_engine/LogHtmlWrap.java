...
public class LogHtmlWrap implements Logger {
    String newStart = "";
    String newFinish = "";
    String before = "";
    String after = "";
    ...
    public LogHtmlWrap(Logger logger) {
        this.logger = logger;
    }
    ...
    public LogHtmlWrap setOnceStartFinish(String start, String finish) {
        newStart = start;
        newFinish = finish;
        return this;
    }
    ...
    public LogHtmlWrap setOnceBefore(String before) {
        this.before = before;
        return this;
    }

    public LogHtmlWrap setOnceAfter(String after) {
        this.after = after;
        return this;
    }
